...
// FileSystem::FindDir
// 根据文件路径返回目标文件的目录结构
// FindDir的类型本来应该为Directory*
// 但是我在头文件中导入derectory.h时运行一直报错
// 所以这里使用void*，后续使用Directory*进行强制转换
//----------------------------------------------------------------------
void* FileSystem::FindDir(char* filePath) {
